...
- (void)configSubViews
{
    ...
    startPointLabel.text = [NSString stringWithFormat:@"起 点(茂名)：%f, %f", self.startPoint.latitude, self.startPoint.longitude];
    ...
    endPointLabel.text = [NSString stringWithFormat:@"终 点(雷州)：%f, %f", self.endPoint.latitude, self.endPoint.longitude];
